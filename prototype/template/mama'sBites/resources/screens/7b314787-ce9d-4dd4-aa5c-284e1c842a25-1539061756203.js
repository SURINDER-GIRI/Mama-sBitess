jQuery("#simulation")
  .on("click", ".s-7b314787-ce9d-4dd4-aa5c-284e1c842a25 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/1f76d92f-8a53-450a-bed7-ab769fc41674",
                    "transition": {
                      "type": "fade",
                      "duration": 300
                    }
  ...
  .on("focusin", ".s-7b314787-ce9d-4dd4-aa5c-284e1c842a25 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-7b314787-ce9d-4dd4-aa5c-284e1c842a25 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
