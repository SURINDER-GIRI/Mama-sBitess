jQuery("#simulation")
  .on("click", ".s-4644e2aa-4b2e-4119-a5e8-3fdad0e26424 .click", function(event, data) {
  ...
  .on("focusin", ".s-4644e2aa-4b2e-4119-a5e8-3fdad0e26424 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-4644e2aa-4b2e-4119-a5e8-3fdad0e26424 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
