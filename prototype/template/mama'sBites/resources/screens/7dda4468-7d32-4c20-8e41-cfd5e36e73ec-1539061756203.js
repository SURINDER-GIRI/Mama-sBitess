jQuery("#simulation")
  .on("click", ".s-7dda4468-7d32-4c20-8e41-cfd5e36e73ec .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/4644e2aa-4b2e-4119-a5e8-3fdad0e26424",
                    "transition": {
                      "type": "fade",
                      "duration": 500
                    }
  ...
  .on("focusin", ".s-7dda4468-7d32-4c20-8e41-cfd5e36e73ec .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-7dda4468-7d32-4c20-8e41-cfd5e36e73ec .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
